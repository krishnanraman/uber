...
uber_orig <- read.csv("C://Users/david/Documents/R/Stat 695/Project/uber/uber.csv", 
                      nrows = 1000*1000, stringsAsFactors = FALSE)
uber <- uber_orig
...
uber$origin_hour <- uber$pickup_datetime %>% str_split (" ") %>% 
