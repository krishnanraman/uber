...
\begin{center}
\includegraphics[scale=0.5]{C://Users/david/Documents/daily_trips.pdf}
\end{center}
...
\begin{center}
\includegraphics[scale=0.3]{C://Users/david/Documents/traceplots.pdf}
\end{center}

## First Question: Posterior Predictive Check

\begin{center}
\includegraphics[scale=0.5]{C://Users/david/Documents/post_pred_check.pdf}
\end{center}

## First Question: Posterior Estimates of Trends

\begin{center}
\includegraphics[scale=0.35]{C://Users/david/Documents/trends.pdf}
\end{center}

## First Question: Weekly Trend

\begin{center}
\includegraphics[scale=0.5]{C://Users/david/Documents/weekly_trend.pdf}
\end{center}

## First Question: Predictions

\begin{center}
\includegraphics[scale=0.5]{C://Users/david/Documents/predictions.pdf}
\end{center}

## Second Question: The Data

\begin{center}
\includegraphics[scale=0.5]{C://Users/david/Documents/st_data.pdf}
\end{center}
...
\begin{center}
\includegraphics[scale=0.35]{C://Users/david/Documents/st_traceplots.pdf}
\end{center}

## Second Question: Posterior Predictive Check

\begin{center}
\includegraphics[scale=0.6]{C://Users/david/Documents/st_post_pred_check.pdf}
\end{center}

## Second Question: Predictions

\begin{center}
\includegraphics[scale=0.5]{C://Users/david/Documents/st_predictions.pdf}
\end{center}

## Third Question: Uber Graphs & Subgraphs

\begin{center}
\includegraphics[scale=0.6]{C://Users/david/Documents/uber_graph.pdf}
\end{center}

## Third Question: Graph of Most Lucrative Edges

\begin{center}
\includegraphics[scale=0.6]{C://Users/david/Documents/uber_small_graph.pdf}
\end{center}
...
\begin{center}
\includegraphics[scale=0.55]{C://Users/david/Documents/optimal_graph.pdf}
\end{center}
...
\begin{center}
\includegraphics[scale=0.5]{C://Users/david/Documents/edge_dists.pdf}
\end{center}
...
- $X_i \sim N(1/8\mu, 1/8\sigma^2) \rightarrow Y \sim N(\mu, \sigma^2)$
- $\mu \sim N(50*8, 8*(7^2))$
- Posterior Dist of Y proportional to product of Prior & Likelihood
...
\begin{center}
\includegraphics[scale=0.55]{C://Users/david/Documents/prior_post.pdf}
\end{center}

## Third Question: Model 2 Posterior Distributions

\begin{center}
\includegraphics[scale=0.55]{C://Users/david/Documents/stan_post.pdf}
\end{center}

## Third Question: Model 2 Posterior Distribution of Mean Fare

\begin{center}
\includegraphics[scale=0.55]{C://Users/david/Documents/mu_post.pdf}
\end{center}

## Fourth Question: Posterior Distributions for Random Circuit

\begin{center}
\includegraphics[scale=0.55]{C://Users/david/Documents/random_post.pdf}
\end{center}

## Fourth Question: Posterior Distribution of Mean Fare for Random Circuit

\begin{center}
\includegraphics[scale=0.45]{C://Users/david/Documents/random_post2.pdf}
\end{center}
...
\begin{center}
\includegraphics[scale=0.45]{C://Users/david/Documents/post_compare.pdf}
\end{center}
