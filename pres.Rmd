...
Comparing two Uber circuits via Confidence Distributions
================================================
- For each theta, we find the proportion of assignments for which the test statistic does not exceed theta. 
- A plot of p-value versus theta is the p-value function we seek, shown below with 95% Fisherian Interval (NOT Confidence Interval) in red.
```{r, echo=FALSE,out.height="80%"}
...
- Inference via MCMC & Variational Bayes
